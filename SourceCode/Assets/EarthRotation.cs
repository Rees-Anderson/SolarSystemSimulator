 ...
 * Final Project
 * 
 * Modified version of TexturePlacement to use Matrix3x3 and is specifically used to "rotate" the Earth by offsetting the texture over time.
*/
...
public class EarthRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Offset = new Vector2(mainModel.EarthRotation, 0.0f);
        //Scale = 
        //Rotation = 
