 ...
 * Final Project
 * 
 * Modified version of TexturePlacement to use Matrix3x3 and is specifically used to "rotate" the Sun by offsetting the texture over time.
*/
...
public class SunRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Offset = new Vector2(mainModel.SunRotation, 0.0f);
        //Scale = 
        //Rotation = 
