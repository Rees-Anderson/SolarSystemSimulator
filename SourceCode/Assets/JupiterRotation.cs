 ...
 * Final Project
 * 
 * Modified version of TexturePlacement to use Matrix3x3 and is specifically used to "rotate" Jupiter by offsetting the texture over time.
*/
...
public class JupiterRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Offset = new Vector2(mainModel.JupiterRotation, 0.0f);
        //Scale = 
        //Rotation = 
