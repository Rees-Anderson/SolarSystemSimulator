 ...
 * Final Project
 * 
 * Modified version of TexturePlacement to use Matrix3x3 and is specifically used to "rotate" Neptune by offsetting the texture over time.
*/
...
public class NeptuneRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Offset = new Vector2(mainModel.NeptuneRotation, 0.0f);
        //Scale = 
        //Rotation = 
