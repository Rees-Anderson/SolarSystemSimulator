 ...
 * Final Project
 * 
 * Modified version of TexturePlacement to use Matrix3x3 and is specifically used to "rotate" Saturn by offsetting the texture over time.
*/
...
public class SaturnRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Offset = new Vector2(mainModel.SaturnRotation, 0.0f);
        //Scale = 
        //Rotation = 
