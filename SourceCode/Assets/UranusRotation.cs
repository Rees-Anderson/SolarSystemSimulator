 ...
 * Final Project
 * 
 * Modified version of TexturePlacement to use Matrix3x3 and is specifically used to "rotate" Uranus by offsetting the texture over time.
*/
...
public class UranusRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Offset = new Vector2(mainModel.UranusRotation, 0.0f);
        //Scale = 
        //Rotation = 
