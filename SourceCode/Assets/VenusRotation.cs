 ...
 * Final Project
 * 
 * Modified version of TexturePlacement to use Matrix3x3 and is specifically used to "rotate" Venus by offsetting the texture over time.
*/
...
public class VenusRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Offset = new Vector2(mainModel.VenusRotation, 0.0f);
        //Scale = 
        //Rotation = 
