 ...
 * Final Project
 * 
 * Modified version of TexturePlacement to use Matrix3x3 and is specifically used to "rotate" Mars by offsetting the texture over time.
*/
...
public class MarsRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Offset = new Vector2(mainModel.MarsRotation, 0.0f);
        //Scale = 
        //Rotation = 
